...
How to compile this code:
	Build a c++ project in a IDE and then add all files under src/ to the project can simply compile it. The compiler need to support c++ 17(and <filesystem> library in it).
...
How to run this code:
	...
	Input can be in both absolute path and relative path. Can be both a file name or a directory. For directories, the program would compile every .jack files under them.
